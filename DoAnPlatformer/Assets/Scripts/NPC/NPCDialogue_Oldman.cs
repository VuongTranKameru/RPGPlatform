...
public class NPCDialogue_Oldman : MonoBehaviour
{
    internal static NPCDialogue_Oldman instance;
    Animator anim;

    NPC_UI_DialogCraft narrative;
    ...
    private void Awake()
    {
        ...
        narrative = FindAnyObjectByType<NPC_UI_DialogCraft>();
    ...
    void NextLine()
    {
        if (endLine < narrative.Dialogue.Length - 1 && doneText)
        {
            ...
            {
                narrative.craftBtn.SetActive(true);
    ...
    public void RemoveText()
    {
        narrative.dialogueText.text = "";
        endLine = 0; //reset
        narrative.craftBtn.SetActive(false);
